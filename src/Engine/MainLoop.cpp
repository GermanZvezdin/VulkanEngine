...
void MainLoop::createRenderPass() {
...
void MainLoop::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void MainLoop::createCommandBuffer() {
...
void MainLoop::createCommandPool() {
...
void MainLoop::createFrameBuffers() {
...
void MainLoop::createGraphicsPipeline() {
...
void MainLoop::createImageViews() {
...
VkShaderModule MainLoop::createShaderModule(const std::vector<char> &code) {
...
MainLoop::SwapChainSupportDetails MainLoop::querySwapChainSupport(VkPhysicalDevice device) {
...
VkSurfaceFormatKHR MainLoop::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats) {
...
VkPresentModeKHR MainLoop::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes) {
...
VkExtent2D MainLoop::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
void MainLoop::createSurface() {
    if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
        throw std::runtime_error("failed to create window surface!");
    }
}

MainLoop::QueueFamilyIndices MainLoop::findQueueFamilies(VkPhysicalDevice device) {
...
void MainLoop::createLogicalDevice() {
    QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
